...
const Landing = () => {
  ...
  return (
    <div className="flex min-h-screen flex-col">
      <div className="max-[360px]:gap-38 m-auto  flex w-screen flex-1 flex-col gap-28 bg-gradient-to-l from-[#A6ECE0] to-[#7ADFBB] pb-4 max-[360px]:pb-6 min-[1920px]:min-h-screen">
        <Navbar />
        <div className="flex flex-wrap items-center justify-center gap-8">
          ...
          <div className=" hidden min-h-[400px] min-w-[340px] 2xl:block ">
            <img alt="hero-image" src="/assets/hero-image.svg" />
          </div>
        </div>
      </div>
      ...
      <div className=" flex min-h-screen w-screen flex-1 items-center justify-center bg-[url('/assets/cta-bg.jpg')] bg-cover bg-center bg-no-repeat ">
